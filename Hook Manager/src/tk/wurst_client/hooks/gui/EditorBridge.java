...
public class EditorBridge
{
	...
	public boolean collectsParams(String methodName, String position)
	{
		return classData.getMethod(methodName).getHook(
			HookPosition.valueOf(position)).collectsParams();
	}
